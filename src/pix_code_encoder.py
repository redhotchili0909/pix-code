...
class Encoder:
    def __init__(
        self, filepath=None, binary_data=None, img_width=1920, img_height=1080
    ):
        self.color_map = {
            "0": (0, 0, 0),
            "1": (255, 255, 255),
    ...
    def create_pngs_from_binary(
        self, output_folder, BLOCK_SIZE, img_index=0, COLOR=True
    ):
        """
        ...
        def process_image(current_data, img_index):
            ...
            img = Image.new(
                mode="RGB", size=(self.img_width, self.img_height), color=(74, 65, 42)
            )
